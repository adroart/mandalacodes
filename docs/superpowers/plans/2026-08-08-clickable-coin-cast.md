...
- [x] **Step 1: Add casting state and timing**
...
- [x] **Step 2: Make the coin group the primary control**
...
- [x] **Step 3: Replace the tumble keyframe**
...
- [x] **Step 4: Keep the controller source synchronized**
...
- [x] **Step 2: Run the design detector**
...
- [x] **Step 3: Inspect desktop and mobile together**
