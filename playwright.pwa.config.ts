...
export default defineConfig({
  testDir: './tests',
  testMatch: ['pwa-learn.spec.ts', 'pwa-navigation.spec.ts', 'offline-qr-reading.spec.ts'],
  reporter: 'list',
  ...
  projects: [
    { name: 'Desktop Chrome', testMatch: ['pwa-learn.spec.ts', 'pwa-navigation.spec.ts'], use: { ...devices['Desktop Chrome'] } },
