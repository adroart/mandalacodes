  ...
  return (
    ...
    >
      <div ref={rowRef} className="max-w-[1800px] mx-auto px-6 md:px-12 flex justify-between items-center relative z-[120]">
        <Link ref={wordmarkRef} to="/" className="group flex flex-col items-stretch leading-none py-2 -my-2 shrink-0" aria-label="Mandala Codes home">
            ...
            return (
              <React.Fragment key={item.path}>
                ...
                {item.external ? (
                  ...
                  <Link to={item.path} className={linkClass} tabIndex={menuFits ? undefined : -1}>
                    {item.label}
                    {underline}
                  </Link>
                )}
