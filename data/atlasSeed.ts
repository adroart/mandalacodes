...
const SEED: SeedPlacement[] = [
  ...
  { pieceId: 'UL-119', cityId: 'lisbon-pt', status: 'placed', placedAt: '2025-03-08', claimOrdinal: 9, intention: "That this house becomes the kind of place my grandmother's kitchen was. A place people walk into and exhale. I want the piece to hold the noise of long dinners, the arguments that end in laughter, the friends who arrive without calling first and stay past midnight. I grew up in rooms where love had to be earned and measured, and I have spent ten years unlearning that arithmetic. So this is the dream I am setting into the wood: that everyone who eats at this table leaves a little heavier with food and a little lighter in the chest. That my children never once wonder whether there is room for them here. That when I am gone, whoever inherits this piece inherits the obligation that comes with it: keep the door unlocked, keep the pot full, let the house stay loud." }, // clustered on the Lisbon point with UL-123 — the long-dream fixture (Fable-authored, ratified 2026-07-18) exercising every length surface
