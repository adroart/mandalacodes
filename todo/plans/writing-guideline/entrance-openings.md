...
52 · Stillness settles in you when a push has run its course.  (Timeless Blossom)
...
52 · Timeless Blossom
Stillness settles in you when a push has run its course. The outside goes quiet so the inside can work. So stay where you are and what comes next will be clear.
