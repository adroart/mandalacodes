...
- [ ] Wire the Adrian Rasmussen quote system to `POST /api/oracle/recommendation` (chart/birth → art + energy), then add pricing + purchase + the client page/PDF on that side _(band: you-required)_ _(effort: deep)_ → Tool: [scripts/chart-lookbook/README.md](scripts/chart-lookbook/README.md)
